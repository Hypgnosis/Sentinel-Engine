 ...
 * ═══════════════════════════════════════════════════════════════
 * Minimal AES-256-GCM decryption for the Veritas Proxy hot path.
 *
 * This module exists to enforce the Principle of Least Privilege:
 *   - The Veritas Proxy needs ONLY DSN decryption authority.
...
function _getMasterKey() {
  ...
  if (!keyHex) {
    throw new Error(
      ...
      'The Veritas Proxy cannot decrypt shard DSNs without this key. ' +
